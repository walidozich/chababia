...
> **RÈGLE :** Tout prompt doit commencer par `[Skills: ALL 13]` et invoquer les
> 13 skills avant toute génération de code. Skills déjà installés dans `~/.agents/skills/`.
...
## 🎨 DESIGN SYSTEM (Extraire de DESIGN.md)
